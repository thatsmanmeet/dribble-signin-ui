    ...
    return (
        ...
        >
            <View style={styles.headerContainer}>
                ...
                <Text style={styles.headerSubText}>{"Let's"} Sign up in 1 minute for free!</Text>
            </View>
            ...
            <View style={styles.formContainer}>
                ...
                <View style={{ flexDirection: "row", width: "100%" }}>
                    <FontAwesome name="lock" style={{ position: "absolute", top: 27, left: 10 }} size={18} />
                    <TextInput style={styles.formInput} placeholder="Confirm your password..." value={confirmpassword} onChangeText={setConfirmPassword} secureTextEntry={true} />
                </View>
            ...
            <View style={styles.footerContainer}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 2 }}>
                    ...
                    <Link style={styles.footerLinks} href={"/"}>Sign In</Link>
                </View>
            </View>
